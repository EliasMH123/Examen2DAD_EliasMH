...
export const updateUser=async(req,res)=>{
    try {
        const id=parseInt(req.params.id);
        const{username,password,idempleado,estado,idrol}=req.body;
        await pool.query('update usuario set username=$1,password=$2,idempleado=$3,estado=$4,idrol=$5 where idusuario=$3',[username,password,idempleado,estado,idrol,id]);
...
export const createUser=async(req,res)=>{
    try {
        ...
        await pool.query('insert into usuario(username,password,idempleado,estado,idrol)values($1,$2,$3,$4,$5)',[username,password2,idempleado,estado,idrol]);
